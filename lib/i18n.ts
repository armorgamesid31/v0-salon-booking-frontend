...
> = {
  tr: {
    welcomeDefault: 'Hoş geldiniz! Bugün sizi şımartmaya hazırız.',
    welcomeBack: (name) => `Selamlar ${name}, tekrar hoş geldin!`,
    people: 'kişi',
    ...
    noAppointment: 'Randevu bulunamadı.',
    confirmAppointment: 'Randevuyu Onayla',
    selectSpecialist: 'Uzman Seç',
    confirmSelection: 'Seçimi Onayla',
    completeProfile: 'Kaydını Tamamla',
    firstName: 'Ad',
    lastName: 'Soyad',
    fullName: 'Ad Soyad',
    phone: 'Telefon',
    registerContinue: 'Kayıt Ol ve Devam Et',
    approvalTitle: 'Randevu Onayı',
    dateAndTime: 'Tarih ve Saat',
    details: 'Detaylar',
    services: 'Hizmetler',
    completeBooking: 'Randevuyu Tamamla',
    bookingInProgress: 'Onaylanıyor...',
    successTitle: 'Randevunuz Alındı!',
    successInfo: 'Onay mesajı telefonunuza gönderilecektir.',
    successButton: 'Harika!',
    openWhatsapp: 'WhatsApp',
    loading: 'Yükleniyor...',
    fillInfoError: 'Lütfen bilgilerinizi doldurun.',
    ...
    dashboard: {
      ...
      packageExpiresLabel: (dateLabel) => `Bitiş: ${dateLabel}`,
      packageNoExpiry: 'Bitiş tarihi yok',
      packageNoActive: 'Aktif paket bulunamadı.',
      packagePolicyNote: 'Sadece aktif paketler listelenir. Özel kombin paketleri salon tarafında oluşturulur.',
      packageQuotaHintUse: 'Bu hak seçili randevuya uygulanır',
      packageQuotaHintEmpty: 'Hak kalmadı',
      packageAdd: 'Ekle',
      packageRemove: 'Çıkar',
      packageOutOfQuota: 'Hak yok',
      appointmentsEmpty: 'Henüz randevu bulunmuyor.',
      specialistLabel: 'Uzman',
      includesRescheduledRecord: 'Bu kayıtta ertelenen randevu geçmişi var',
      actionRepeat: 'Tekrarla',
      actionCancel: 'İptal Et',
      actionUpdate: 'Güncelle',
      actionEvaluate: 'Değerlendir',
      secureLinkRequiredUpdate: 'Randevu güncellemek için güvenli bağlantı gerekli.',
      secureLinkRequiredCancel: 'Randevu iptal etmek için güvenli bağlantı gerekli.',
      secureLinkRequiredFeedback: 'Değerlendirme göndermek için güvenli bağlantı gerekli.',
      cancelConfirm: 'Seçili randevuları iptal etmek istiyor musunuz?',
      cancellationFailed: 'İptal işlemi başarısız oldu.',
      noServiceToRepeat: 'Tekrarlamak için hizmet bilgisi bulunamadı.',
      serviceFilterMismatch: 'Bu hizmetler mevcut filtrede görünmüyor. Lütfen filtreyi değiştirin.',
      packageServiceLoadFailed: 'Paket hizmeti yüklenemedi. Sayfayı yenileyip tekrar deneyin.',
      noQuotaLeftForPackageService: 'Bu paket hizmeti için hak kalmadı.',
      selectValidDateTime: 'Lütfen geçerli tarih ve saat seçin.',
      rescheduleSlotUnavailable: 'Seçilen saat uygun değil.',
      reschedulePreviewFailed: 'Önizleme oluşturulamadı.',
      rescheduleConflict: 'Takvim çakışması var.',
      rescheduleFailed: 'Randevu güncellenemedi.',
      ...
      totalLabel: 'Toplam',
      paymentFreeLabel: 'Ücretsiz',
      fromPackageLabel: 'Paketten',
      removeManual: 'Manuel Çıkar',
      minuteUnit: 'dk',
      rescheduleTitle: 'Randevuyu Güncelle',
      rescheduleDescription: 'Yeni tarih ve saat seçin. Ardışık hizmetler birlikte taşınır ve süre korunur.',
      dateLabel: 'Tarih',
      timeLabel: 'Saat',
      checkingLabel: 'Kontrol ediliyor...',
      checkAvailabilityLabel: 'Müsaitlik Kontrol Et',
      chooseSpecialistPrompt: 'Tercih edilen uzman müsait değil. Lütfen uzman seçin:',
      cancelButton: 'Vazgeç',
      savingLabel: 'Kaydediliyor...',
      confirmUpdateLabel: 'Güncellemeyi Onayla',
    },
  },
  en: {
