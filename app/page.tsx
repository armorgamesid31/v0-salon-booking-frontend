...
import { BookingStep, BookingState, Service, TimeSlot, BookingConfirmation } from '@/types'
import { validateToken, fetchServices, fetchAvailableSlots, confirmBooking } from '@/api'
